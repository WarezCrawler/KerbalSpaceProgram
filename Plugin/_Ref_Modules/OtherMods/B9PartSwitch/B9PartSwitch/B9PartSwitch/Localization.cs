...
public static class Localization
{
	...
	static Localization()
	{
		GameEvents.onLanguageSwitched.Add(delegate
		{
			RefreshLocalization();
		});
		RefreshLocalization();
	...
	private static void RefreshLocalization()
	{
		...
		PartSwitchFlightDialog_AcceptString = Localizer.GetStringByTag("#autoLOC_6001205");
		PartSwitchFlightDialog_CancelString = Localizer.GetStringByTag("#autoLOC_6001206");
		...
		SwitcherSubtypeDescriptionGenerator_Resources = Localizer.GetStringByTag("#autoLOC_6001746");
		SwitcherSubtypeDescriptionGenerator_Mass = Localizer.GetStringByTag("#autoLOC_900529");
		SwitcherSubtypeDescriptionGenerator_Cost = Localizer.GetStringByTag("#autoLOC_900528");
		...
		switcherSubtypeDescriptionGenerator_MassTons = Localizer.GetStringByTag("#autoLOC_5050023").Replace("<<1>>", "<<1>> ");
		switcherSubtypeDescriptionGenerator_TemperatureKelvins = Localizer.GetStringByTag("#autoLOC_5050037");
		switcherSubtypeDescriptionGenerator_SpeedMetersPerSecond = Localizer.GetStringByTag("#autoLOC_5050034");
	}
}
