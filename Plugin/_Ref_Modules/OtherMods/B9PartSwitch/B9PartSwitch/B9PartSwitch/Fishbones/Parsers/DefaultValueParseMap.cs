...
{
	public static readonly IValueParser StringParser = new ValueParser<string>((string s) => s, (string s) => s);

	public static readonly IValueParser BoolParser = new ValueParser<bool>(bool.Parse, (bool x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser CharParser = new ValueParser<char>(char.Parse, (char x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser ByteParser = new ValueParser<byte>(byte.Parse, (byte x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser SByteParser = new ValueParser<sbyte>(sbyte.Parse, (sbyte x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser ShortParser = new ValueParser<short>(short.Parse, (short x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser UShortParser = new ValueParser<ushort>(ushort.Parse, (ushort x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser IntParser = new ValueParser<int>(int.Parse, (int x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser UIntParser = new ValueParser<uint>(uint.Parse, (uint x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser LongParser = new ValueParser<long>(long.Parse, (long x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser ULongParser = new ValueParser<ulong>(ulong.Parse, (ulong x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser FloatParser = new ValueParser<float>(float.Parse, (float x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser DecimalParser = new ValueParser<decimal>(decimal.Parse, (decimal x) => x.ToString(CultureInfo.InvariantCulture));

	public static readonly IValueParser DoubleParser = new ValueParser<double>(double.Parse, (double x) => x.ToString(CultureInfo.InvariantCulture));
	...
	public static readonly IValueParser ColorParser = new ValueParser<Color>(B9PartSwitch.Utils.ColorParser.Parse, ConfigNode.WriteColor);

	public static readonly IValueParser Color32Parser = new ValueParser<Color32>(ConfigNode.ParseColor32, ConfigNode.WriteColor);

	public static readonly IValueParser StringMatcherParser = new ValueParser<IStringMatcher>(StringMatcher.Parse, (IStringMatcher s) => s.ToString());
	...
	public override IValueParser GetParser(Type parseType)
	{
		...
		{
			Type parseType2 = parseType.GetGenericArguments()[0];
			if (IsRegisteredParserOrEnum(parseType2))
			{
				return GetRegisteredParserOrEnum(parseType2);
			}
		}
	...
	public override bool CanParse(Type parseType)
	{
		...
		if (parseType.IsNullableValueType() && IsRegisteredParserOrEnum(parseType.GetGenericArguments()[0]))
		{
			return true;
		}
		return false;
