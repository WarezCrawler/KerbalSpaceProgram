...
public static class ResourceColors
{
	...
	public static Color LqdHydrogen = new Color(0.6f, 0.8f, 1f);

	public static Color LqdMethane = new Color(0f, 0.749f, 0.561f);

	public static Color MonoPropellant = new Color(1f, 1f, 0.8f);

	public static Color Oxidizer = new Color(0.2f, 0.6f, 0.8f);

	public static Color XenonGas = new Color(0.376f, 0.655f, 0.749f);

	public static Color ElectricChargePrimary = new Color(1f, 1f, 0.2f);
