...
public class LockedSubtypeWarningHandler
{
	...
	private static void UpsertDialog(string message)
	{
		...
		dialog = PopupDialog.SpawnPopupDialog(new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new MultiOptionDialog("B9PartSwitchLockedSubtypeWarning", "Some parts have locked subtypes selected.  They have been replaced with the highest priority unlocked subtype\n\n" + string.Join("\n\n", allMessages.ToArray()), "B9PartSwitch - Locked Subtypes", HighLogic.UISkin, new Rect(0.5f, 0.5f, 500f, 60f), new DialogGUIFlexibleSpace(), new DialogGUIHorizontalLayout(new DialogGUIBase[3]
		{
