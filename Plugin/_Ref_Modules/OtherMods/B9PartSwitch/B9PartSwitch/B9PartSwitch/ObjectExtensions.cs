...
public static class ObjectExtensions
{
	...
	public static void EnsureArgumentType<T>(this object o, string paramName)
	{
		o.EnsureArgumentType(typeof(T), paramName);
	}
	...
	public static void EnsureArgumentType<T1, T2>(this object o, string paramName)
	{
		...
		{
			Type type = o.GetType();
			if (!type.Implements<T1>() && !type.Implements<T2>())
			{
				throw new ArgumentException($"Expected parameter of type {typeof(T1)} or {typeof(T2)} but got {type}", paramName);
			}
		}
	}
}
