...
namespace GTI
{
    // DISABLE [KSPScenario(ScenarioCreationOptions.AddToAllGames, GameScenes.FLIGHT)]
    public class GTI_ProjectManagerScenario_v2 : ScenarioModule
    {
        ...
        public void OnEnable()
        {
            ...
            GTIDebug.Log("GTI_ProjectManagerScenario v2 Starting", "GTI - PM", GTIConfig.iDebugLevel.DebugInfo);
